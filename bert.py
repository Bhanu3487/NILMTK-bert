...
class BERT(Disaggregator):
    ...
    def __init__(self, params):
        ...
        if self.sequence_length%2==0:
            print ("Sequence length should be odd!") #to ensure that there is a central point in the sequence. This allows symmetrical padding on both sides of the central point
